###########################################################################
## Makefile generated for component 'medida_A'. 
## 
## Makefile     : medida_A.mk
## Generated on : Mon Nov 14 17:10:48 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/medida_A.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/medida_A.elf
...
DEFINES_ = -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DMW_TIMERID=1 -DMW_PRESCALAR=256 -DMW_TIMERCOUNT=64911 -DMW_SCHEDULERCOUNTER=1 -DARDUINO_NUM_SERIAL_PORTS=1 -D_RTT_BAUDRATE_SERIAL0_=9600 -D_RTT_ANALOG_REF_=1
...
DEFINES_STANDARD = -DMODEL=medida_A -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_AnalogInput.o ArduinoPinHandleMap.o medida_A.o medida_A_data.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o
...
%.o : $(START_DIR)/medida_A_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/medida_A_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/medida_A_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/medida_A_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


medida_A.o : $(START_DIR)/medida_A_ert_rtw/medida_A.c
	$(CC) $(CFLAGS) -o "$@" "$<"


medida_A_data.o : $(START_DIR)/medida_A_ert_rtw/medida_A_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
