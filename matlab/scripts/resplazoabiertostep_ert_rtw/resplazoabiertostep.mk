###########################################################################
## Makefile generated for component 'resplazoabiertostep'. 
## 
## Makefile     : resplazoabiertostep.mk
## Generated on : Mon Dec 12 19:10:28 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/resplazoabiertostep.elf
...
PRODUCT_NAME              = resplazoabiertostep
MAKEFILE                  = resplazoabiertostep.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2021a
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2021a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = D:/UPM/4 - Cuarto/TFG/Repo/TFG-Mano-amiga/matlab/scripts
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
SLIB_PATH        = C:/Users/SIMN~1/DOCUME~1/MATLAB/R2021a/ARDUIN~1/ARDUIN~1/FASTER~1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/resplazoabiertostep.elf
...
DEFINES_ = -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DMW_TIMERID=2 -DMW_PRESCALAR=256 -DMW_TIMERCOUNT=131 -DMW_SCHEDULERCOUNTER=5 -DARDUINO_NUM_SERIAL_PORTS=1 -D_RTT_BAUDRATE_SERIAL0_=9600 -D_RTT_ANALOG_REF_=0
...
DEFINES_STANDARD = -DMODEL=resplazoabiertostep -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_PWM.o MW_PWMDriver.o ArduinoPinHandleMap.o MW_AnalogInput.o resplazoabiertostep.o resplazoabiertostep_data.o updown.o ext_work.o rtiostream_utils.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o rtiostream_interface.o ext_svr_daemon.o rtiostream_serial_daemon.o daemon_checksum.o
...
%.o : $(START_DIR)/resplazoabiertostep_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/resplazoabiertostep_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/resplazoabiertostep_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/resplazoabiertostep_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


resplazoabiertostep.o : $(START_DIR)/resplazoabiertostep_ert_rtw/resplazoabiertostep.c
	$(CC) $(CFLAGS) -o "$@" "$<"


resplazoabiertostep_data.o : $(START_DIR)/resplazoabiertostep_ert_rtw/resplazoabiertostep_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
